...
class FetchMCPAgent:
    ...
    async def run_task(self):
        ...
        try:
            ...
            if agent_messages:
                fetch_operator_msgs = [m for m in agent_messages if 'Fetch_Operator' in m['agent']]
                operator_response = fetch_operator_msgs[0]['content'] if fetch_operator_msgs else final_response

                self.conv_logger.log_conversation_turn(
                    agent="Fetch_Operator",
