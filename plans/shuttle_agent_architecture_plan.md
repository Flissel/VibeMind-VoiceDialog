...
- AG2 Swarm Integration (USE_AG2_SWARM=true)
...
**Spezialisierung:**
- Spezialisierte Sub-Agents für Shuttle-Domain
- Ähnlich wie Ideas/Coding/Desktop Sub-Agents
- Nutzen AutoGen 4.0 für spezialisierte Aufgaben

**Sub-Agent-Typen:**
1. **shuttle_requirements_analyst**: Requirements-Analyse und Validierung
2. **shuttle_pipeline_manager**: Pipeline-Management und Stufen-Koordination
3. **shuttle_exporter**: Export in verschiedene Formate
4. **shuttle_validator**: Requirements-Validierung gegen Spezifikationen
...
7. AG2 Swarm Integration implementieren (optional)
...
**Schritte:**
1. create_shuttle_requirements_analyst() erstellen
2. create_shuttle_pipeline_manager() erstellen
3. create_shuttle_exporter() erstellen
4. create_shuttle_validator() erstellen
...
### 7.6 AutoGen Swarm Integration erstellen
...
2. **Shuttle Sub-Agents**: 4 spezialisierte Sub-Agents
